...
user = User.create!(name: "Stu", email: "stu@email.com", password: "password")
...
user = User.create!(name: "Blarb", email: "Blarb@email.com", password: "password")

room = Room.create!(user_id: user.id, planet: "Cropirus", price: 40, description: "Extremely Windy. Rent with caution" total_occupancy: 10, total_bedrooms: 6, total_bathrooms: , home_type: "Ice Pit", section: "Lower Hemisphere")
